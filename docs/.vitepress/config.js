...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        ...
        items: [
          { text: "起步", link: "/guide/" },
          { text: "发展史", link: "/guide/history" },
        ],
      },
      {
        text: "游戏服",
        items: [
          { text: "体系", link: "/server/system" },
          { text: "目录结构", link: "/server/directory" },
          { text: "运行", link: "/server/run" },
          { text: "部署", link: "/server/deploy" },
          { text: "致谢", link: "/server/credits" },
        ],
      },
    ],
    footer: {
    ...
    socialLinks: [
      ...
      {
        icon: "github",
        link: "https://github.com/yucarl77",
      },
    ],
  },
});
